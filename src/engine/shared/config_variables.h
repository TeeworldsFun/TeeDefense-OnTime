...
MACRO_CONFIG_INT(SvTowerHealth, sv_tower_health, 500, 1, 1000, CFGFLAG_SERVER, "Tower max health.")
MACRO_CONFIG_INT(SvTowerLevel, sv_tower_level, 10, 1, 1000, CFGFLAG_SERVER, "Tower max level.")
